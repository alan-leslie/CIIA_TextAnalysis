...
public class EnglishStopWords {
    ...
    public static EnglishStopWords getInstance() {
        return EnglishStopWordsHolder.INSTANCE;
    }
    
    private static class EnglishStopWordsHolder {

        private static final EnglishStopWords INSTANCE = new EnglishStopWords();
    }

// Contributed to Lucene on 2002-09-21 by "John Caron" <caron@unidata.ucar.edu>
//
// See also:
